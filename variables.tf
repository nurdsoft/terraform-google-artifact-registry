...
variable "repository_id" {
  ...
  validation {
    ...
    error_message = "repository_id must be 2-63 characters, start and end with a lowercase letter or number, and contain only lowercase letters, numbers, and hyphens."
  }
}
